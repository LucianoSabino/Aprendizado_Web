...
let selectedImgIndex = 0; // indicação do slider
...
function onPreviousClick() {
    ...
    handSliderClick()
    --selectedImgIndex; // dindicação do slider
    handleActiverDot()
...
function handleActiverDot () { //parte das bolinhas indicadoras 
...
function autoScroll() {
    ...
    interval = setInterval( () => {
        ...
        if(numberOfImages === selectedImage) {
            ...
            selectedImgIndex = 0 // dindicação do slider
            handleActiverDot()
            return
        }
